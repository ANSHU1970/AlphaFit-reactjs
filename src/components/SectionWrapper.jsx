  ...
  return (
    ...
    gap-10'>
        ...
        justify-center items-center'>
            ...
            md:text-5xl lg:text-6xl'>{title[0]} <span className='uppercase text-orange-400'>{title[1]}</span> {title[2]} <span className='uppercase text-orange-400'>{title[3]}</span></h2>
